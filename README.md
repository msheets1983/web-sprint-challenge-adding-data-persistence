...
A relational database organizes data into tables which can be linked to other databases and need a predefined schema. SQL is a query language used to communicate with a database.
